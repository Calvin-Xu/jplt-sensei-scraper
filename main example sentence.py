...
for i in range(1, 5 + 1):
	url = "https://jlptsensei.com/jlpt-n2-grammar-list/page/" + str(i) + "/"
...
#				f.close()
				...
				try:
					...
					exampleDiv = flashCardSoup.find_all("p", {"class": "m-0 jp"})[0]
					exampleSentence = exampleDiv
					print(exampleSentence)
					f = open("n2.txt", "a")
					f.write(index + "|" + str(exampleSentence) + "\n")
					f.close()
